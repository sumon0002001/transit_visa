...
Visa For Italy              </Badge>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-tight">
                Connect with Italy <br />
                <span className="gradient-title">anytime, anywhere</span>
              </h1>
              <p className="text-muted-foreground text-lg md:text-xl max-w-md">
               Apply for Visa Anytime from anywhere
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                >
                  <Link href="/">Find Your Visas</Link>
                </Button>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              Our platform makes visa accessible with just a few clicks
            </p>
          </div>
      ...
      <section id="pricing" className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              Choose the perfect consultation package 
            </p>
          </div>
            ...
            <CardContent className="p-8 md:p-12 lg:p-16 relative overflow-hidden">
              <div className="max-w-2xl relative z-10">
                <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
                  Ready to take control of your visa?
                </h2>
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  <Button
                    ...
                    className="border-emerald-700/30 hover:bg-muted/80"
                  >
                    <Link href="#pricing">View Visa</Link>
                  </Button>
                </div>
              </div>
